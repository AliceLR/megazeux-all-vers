...
mzx293b-x64:
	${DL} ${URLBASE}/v2.93b/mzx293b-x64.zip $@
	${DL} ${URLBASE}/v2.93b/mzx293bsrc.tar.xz ${src}/mzx293b tar.xz

mzx293c-x64:
	${DL} ${URLBASE}/v2.93c/mzx293c-x64.zip $@
	${DL} ${URLBASE}/v2.93c/mzx293csrc.tar.xz ${src}/mzx293c tar.xz
